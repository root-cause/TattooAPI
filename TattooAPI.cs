...
namespace TattooAPI
{
    ...
    {
        const string TATTOO_DATA_DIR = "TattooData"; // This is the directory that will keep tattoo data
        const string SAVE_DIR = "PlayerData"; // This is the directory that will keep player tattoo data
